# Тема: Приложение по предоставлению услуг спортзала. 
В этом проекте будут представлены:
+ Реализация CRUD-операций для работы с услугами(для создателя).
+ Возможность выбрать для себя тренировку из списка доступных(доступные тренировки добавляются создателем проекта). Тренировки будут двух типов. Можно будет приобрести безлимит на определённый период времени или определённое количество занятий. Взаимодействие будет происходить с использованией API.
